...
txtEtanol=customtkinter.CTkEntry(app)
...
txtGasolina=customtkinter.CTkEntry(app)
...
txtCarroEtanol=customtkinter.CTkEntry(app)
...
txtCarroGasolina=customtkinter.CTkEntry(app)
txtCarroGasolina.place(x=150,y=200,width=200,height=40)


# Botão Calcular
btnCalc = customtkinter.CTkButton(master=app, width=60, height=32, corner_radius=8, text="Calcular", command=ResultadoCombustiveis)
btnCalc.place(x=140, y=250)


# Botão Limpar
btnClean = customtkinter.CTkButton(master=app, width=60, height=32, corner_radius=8, text="Limpar", command=Limpar)
btnClean.place(x=220, y=250)
